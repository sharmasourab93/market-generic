...
def test_option_chain_object(index_option_chain, dated):
...
def test_pcr_verdict(index_option_chain):
    for oc_obj in index_option_chain:
...
def test_overall_pcr(index_option_chain):
    for oc_obj in index_option_chain:
...
def test_option_chain_output(index_option_chain):
    for oc_obj in index_option_chain:
